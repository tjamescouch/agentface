"""Sentiment brain — keyword lexicon scoring with recency weighting and decay.

Ported from visage/brain.py with no algorithmic changes.
"""
...
class SentimentBrain:
    ...
    def step(self, dt: float, timestamp: float):
        """Advance emotion state by one time step."""
    ...
    def _analyze(self):
        """Score the recent window against keyword lexicons."""
